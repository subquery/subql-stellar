...
export class TestingService extends BaseTestingService<
  ...
  SubqlDatasource
> {
  constructor(nodeConfig: NodeConfig, @Inject('ISubqueryProject') project: SubqueryProject) {
  ...
  async getTestRunner(): Promise<
    [
      close: () => Promise<void>,
      runner: TestRunner<StellarApi, SafeStellarProvider, StellarBlockWrapper, SubqlDatasource>,
    ]
  > {
    const testContext = await NestFactory.createApplicationContext(TestingModule, {
